...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            preprocessor = ColumnTransformer([
                ...
                ('categorical_pipline',cat_pipeline, categorical_columns),
            ])
            logging.info("Created a preprocessor")
            return preprocessor
    ...
    def initiate_data_transform(self, train_path, test_path):
        ...
        try:
            ...
            logging.info("Applying the preprocessing pipeline on the data.")
            ...
            logging.info("Data is being broken.")
